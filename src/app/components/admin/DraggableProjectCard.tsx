    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className={`text-xs font-medium truncate ${isExpanded ? 'text-purple-300' : 'text-white/80'}`}>{project.title}</p>
          <p className="text-white/30 text-[10px] truncate">{project.category} • {project.year}</p>
        </div>
